...
//        }
        ...
        phoneBook.add("Petrov", new ArrayList<>(Arrays.asList("970", "971", "972", "973")));
        phoneBook.add("Petrov", "980");
        phoneBook.add("Sidorov", "900");
        phoneBook.add("1", new ArrayList<>());
        phoneBook.add("2", "");
        phoneBook.add("", "88002000099");
        phoneBook.add("", new ArrayList<>(Arrays.asList("1000", "1001", "1002")));


        System.out.println("Petrov's phone number: " + phoneBook.get("Petrov"));
        System.out.println(phoneBook.get("1001"));
